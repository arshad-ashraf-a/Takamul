...
namespace Takamul.Portal.Providers
{
    public class TakamulMembershipProvider : MembershipProvider
    {
        ...
        {
            LoginServices oLoginServices = new LoginServices();
            oLoginServices.sUserName = username;
            oLoginServices.sPassword = password;
            oLoginServices.DBConnectionString = ApplicationKeys.TakamulConnectionString;
            User user = oLoginServices.AuthenticateUser();
        ...
        {
            if (Infrastructure.Utilities.BaseController.CurrentUser != null)
            {
                return new MembershipUser("LDCMembershipProvider", username, Infrastructure.Utilities.BaseController.CurrentUser.nUserID, Infrastructure.Utilities.BaseController.CurrentUser.sUserName, null, null, true, false, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue);
            }
            else
            {
                return null;
