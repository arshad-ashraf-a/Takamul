...
var NotificationType = { Notice: "StatusBarNotice", Success: "StatusBarSuccess", Warning: "StatusBarWarning", Error: "StatusBarError" };
...
$(function () {
    ...
    $.widget("ui.timespinner", $.ui.spinner, {
        ...
        _format: function (value) {
            if (value == "-99") {
                return Globalize.format(new Date(), "t");
            }
